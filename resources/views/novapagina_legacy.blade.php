                    ...
                    <div class="row flex-nowrap overflow-auto centralizar">
                        @php
                            $modoPrecos = in_array(($curso->modo_precos ?? 'padrao'), ['padrao', 'um_preco', 'dois_precos'], true)
                                ? $curso->modo_precos
                                : 'padrao';
                            $mostrarPlanoSecundario = !$desconto_banner
                        ...
                        @endif
                        <div class="@if($mostrarPlanoSecundario) col-sm-5 col-11 @else col-12 @endif p-3 bg-portal border rounded rounded-3 mx-auto">
