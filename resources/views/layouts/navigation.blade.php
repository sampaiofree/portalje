            ...
            @if (Auth::user()->nivel_acesso == App\Models\User::NIVEL_ACESSO_ADMIN)
                <div class="pt-2 pb-1 border-t border-gray-200">
                    ...
                    <div class="mt-2 space-y-1">
                        ...
                        <x-responsive-nav-link :href="route('admin.users.index')">Usuários</x-responsive-nav-link>
                        ...
                        <x-responsive-nav-link :href="route('admin.root_domain_course_pages')">Páginas dos Domínios</x-responsive-nav-link>
