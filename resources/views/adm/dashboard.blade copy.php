...
@section('content')
    ...
    <div class="row">
            ...
            <div class="col">
                <div class="card widget-flat">
                    <div class="card-body">
                        <div class="float-end">
                            <i class="bg-primary text-white mdi mdi-currency-usd widget-icon"></i>
                        </div>
                        <h5 class="text-muted fw-normal mt-0" title="Average Revenue">Seu faturamento</h5>
                        <h3 class="mt-3  mb-0">R${{ number_format($total_sum, 2, ',', '.') }}</h3>
                        <p class="mb-0 ">
                            {{ $quantidade_vendas}} @if($quantidade_vendas>1) vendas @else venda @endif no Total
                        </p>
                        @if($aguardadndo['n'])
                        <h5 class="mt-2  mb-0">R${{ number_format($aguardadndo['soma'], 2, ',', '.') }} </h5>
                        <p class="mb-0 fs-6 ">
                            {{ $aguardadndo['n']}} @if($aguardadndo['n']>1) vendas @else venda @endif aguardando pagamento
                        </p>
                        @endif
                        <p class="mt-2 mb-0 text-muted" style="font-size: x-small">Valor bruto do produto. Não se refere ao total da comissão.</p>
                    </div> <!-- end card-body-->
                </div>
            </div>
            @endif

            @if($vencidos AND $vencidos['n']>1)
                <div class="col">
                    <div class="card widget-flat">
                        <div class="card-body">
                            <div class="float-end">
                                <i class="text-white bg-danger ri-alert-fill widget-icon"></i>
                            </div>
                            <h5 class="text-muted fw-normal mt-0" title="Average Revenue">Recupere suas vendas</h5>
                            <h3 class="mt-3 mb-0">R${{ number_format($vencidos['soma'], 2, ',', '.') }}</h3>
                            <p class="mb-0 ">
                                {{ $vencidos['n']}} @if($vencidos['n']>1) vendas expiradas @else venda expirada @endif 
                            </p>
                            @if($canceladas['n'])
                            <h5 class="mt-2  mb-0">R${{ number_format($canceladas['soma'], 2, ',', '.') }} </h5>
                            <p class="mb-0 fs-6 ">
                                {{ $canceladas['n']}} @if($canceladas['n']>1) vendas canceladas @else venda cancelada @endif 
                            </p>
                            @endif
                            <p class="mt-2 mb-0 text-muted" style="font-size: x-small">Recupere as vendas usando o menu "Leads"</p>
                        </div> <!-- end card-body-->
                    </div>
                </div>
            @endif
            ...
            @if($dashboard['conversao_vendas'])
                <div class="col">
                    <div class="card widget-flat">
                        <div class="card-body">
                            <div class="float-end">
                                <i class="text-white bg-info ri-user-follow-fill widget-icon"></i>
                            </div>
                            <h5 class="text-muted fw-normal mt-0" title="Average Revenue">Conversão do Atendimento</h5>
                            <h3 class="mt-3 mb-0 @if($dashboard['conversao_vendas']<5) text-danger @else text-success @endif">{{$dashboard['conversao_vendas']}}%</h3>
                            <p class="mb-0 ">
                                @if($dashboard['conversao_vendas']<5) Você precisa melhorar o seu atendimento. @else Parabéns, você tem um excelente atendimento.  @endif A média ideal é 5%
                            </p>
                            <p class="mt-2 mb-0 text-muted fs-6">Você tem {{$dashboard['totalLeads']}} leads e {{ $quantidade_vendas}} @if($quantidade_vendas>1) vendas @else venda @endif no Total.</p>
                        </div> <!-- end card-body-->
                    </div>
                </div>
            @endif
            ...
            <div class="col">
                <div class="card cta-box">
                    <div class="card-body">
                        <div class="float-end">
                            <i class="text-white bg-success ri-customer-service-2-fill widget-icon"></i>
                        </div>
                        <h5 class="text-muted fw-normal mt-0" title="">Suporte pelo WhatsApp</h5>
                        <h5 class="mt-2  mb-0"><a target="_blank" href="{{route('suporte_alunos')}}" >{{route('suporte_alunos')}}</a></h5>
                        <p class="mb-0 fs-6 ">
                            Copie o link acima e envie para o aluno. Ele será direcionado para o nosso WhatsApp de suporte ao aluno. Não atendemos afiliados neste WhatsApp.
                        </p>
    
    
                        <h5 class="mt-2  mb-0"><a target="_blank" href="https://chat.whatsapp.com/Lb7F6OSFUvx1kmyp4h7kgT" >Grupo dos Afiliados</a></h5>
                        <p class="mb-0 fs-6 ">
                            Grupo no WhatsApp de avisos e de Suporte para afiliados.
                        </p>
            ...
            <div class="col">
                <div class="card border widget-flat">
                    ...
                    <div class="card-body mt-0 pt-0">
                        <p class="mb-0"><a href="https://docs.google.com/document/d/1zsugYFiec7bczVNQ68_XqT4Uax2WeB_SYeJ1cLuPq0E/edit?usp=sharing" target="_blank"><i class="ri-link   me-1"></i>Script de Atendimento</a></p>
                        ...
                        <p class="mb-0"><a href="https://www.canva.com/design/DAGY7scuT1s/EM6lbJXUZ7U94SSNqYazOw/view?mode=preview" target="_blank"><i class="ri-link me-1"></i>Criativos do Método Carvalho</a></p>
                    </div> 
                </div>
            </div>
    </div>
    <div class="row">
        <div class="col-12">
                @if(Auth::user()->dominio OR Auth::user()->dominio_externo)
                    @php 
                    ...
                    <div class="card cta-box bg-info text-white">
                        <div class="card-header mb-0 pb-0 d-flex justify-content-between align-items-center">
                            <h4 class="">Seu site já está funcionando!<br>
                                <small style="font-size: 10pt;font-weight: normal;">
                        ...
                        <div class="card-body pt-0">
                            <div class="row ">
                                <p class="mb-0">
                                    <i class=" ri-global-line me-1"></i>  Seu site é: 
                                    <a class="text-white href_dominio" target="_blank"  href="https://{{$dominio}}"><strong class="dominio_atual">{{$dominio}}</strong></a>
                                </p>
                                

                                @if(Auth::user()->whatsapp_atendimento)
                                    <p class="mb-0">
                                        <i class="  ri-whatsapp-fill me-1"></i>  Seu WhatsApp de atendimento é: 
                                        <a href="javascript:void(0);" class="text-white" data-bs-toggle="modal" data-bs-target="#modal_form_user_whatsapp_atendimento"><strong class="mostrar_whatsapp_atendimento">{{Auth::user()->whatsapp_atendimento}}</strong></a>
                                    </p>
                                    
                                @else
                                    <p class="mb-0">
                                        <i class="  ri-whatsapp-fill me-1"></i>
                                        <a href="javascript:void(0);" class="fs-5 text-white href_dominio" data-bs-toggle="modal" data-bs-target="#modal_form_user_whatsapp_atendimento">
                                            Você não cadastrou seu WhatsApp de atendimento! <strong>Clique AQUI para cadastrar</strong>
                                        </a>
                                    </p>
                            ...
                            <div class="row g-2">
                                <div class="col-12">
                                    <h5 class="mb-0 pb-0 d-flex align-items-center"><a href="#" class="bg-warning text-white p-1" onclick="video_de_ajuda('ckdW5WLA5Cg','','')" >Clique AQUI para saber mais sobre os seus links</a>
                                    </h5>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col">
                                    ...
                                    <select id="selectCupom" class="form-select">
                                        ...
                                        <option value="o80">80% de desconto</option>
                                    </select>
                                </div>
                    
                                <div class="col">
                                    <label for="input_cidade" class="form-label">Nome da Cidade</label>
                                    <input type="text" id="input_cidade" class="form-control" placeholder="Digite o nome da cidade">
                                </div>

                                <div class="col">
                                    <label for="input_whatsapp2" class="form-label">WhatsApp 2</label>
                                    <input type="number" id="input_whatsapp2" class="form-control" placeholder="Digite o WhatsApp de atendimento diferente da conta">
                                </div>
                            </div>
        ...
        <div class="col">
            <div class="card border widget-flat">
                ...
                <div class="card-body mt-0 pt-0">
                    ...
                    <p class="mb-0"><a href="https://youtube.com/playlist?list=PL8UPaaNJEdSDFGX9Pj20RBn7QCn7aSbaU&feature=shared" target="_blank"><i class="  ri-youtube-line    me-1"></i>Curso Método Carvalho: O Melhor Método de Vendas para Iniciantes</a></p>
