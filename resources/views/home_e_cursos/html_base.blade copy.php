...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{asset('img/logo/logo-dark-je-sm.png')}}" >

    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">

    <!-- Theme Config Js -->
    {{-- <script async src="{{asset('Hyper_v5.4/Admin/dist/saas/assets/js/hyper-config.js')}}" ></script> --}}
  ...
  <section class="container-fluid">
    ...
    <div class="row pt-4">
        <div class="col-12  text-center">
            {{-- <img loading="lazy" alt="Portal Jovem Empreendedor" src="{{asset('img/home_page/logojecolor.webp')}}" class="img-fluid " width="200" height="52"> --}}
            <h1 class="topicos mb-0 mx-auto">{!!$pagina['headline']!!}</h1>
            <h4 class="mx-auto my-3">{{$pagina['headline_sub']}}</h4>
            <a href="#content" class="btn btn-lg text-white" style="background-color: #0B5ED7">{{$pagina['headline_botao']}}</a>
        </div>
    </div>
    ...
    <div class="row pt-4 px-2">
        <div class="col-12 text-center">
            <h2 class="topicos">4 motivos para você fazer um curso profissionalizante</h2>
        </div>
        <div id="por_que_se_qualificar" class="row flex-nowrap overflow-auto p-2">
                ...
                <div class="card cta-box border h-100">
                    <div class="card-body p-2">
                        <div class="text-center">
                            <img class="img-fluid rounded-circle" src="{{asset('img/home_page/qualificacao.webp')}}" width="120" alt="Generic placeholder image">
                        </div>
                        <h3 class="mt-3 fw-normal cta-box-title text-center text-danger">Cansado de perder oportunidades por <b>falta de qualificação?</b></h3>
                        <p class="mt-2 text-dark">Destaque-se no mercado de trabalho com qualificação de excelência! Nossos cursos são a chave para abrir as portas de um emprego dos sonhos. Invista em você e aumente suas chances de uma carreira de sucesso.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-2 col-11 p-1">
                <div class="card cta-box border h-100">
                    <div class="card-body p-2">
                        <div class="text-center">
                            <img class="img-fluid rounded-circle" src="{{asset('img/home_page/semexperiencia.webp')}}" width="120">
                        </div>
                        <h3 class="mt-3 fw-normal cta-box-title text-center text-danger">Não te contratam por que <b>não tem experiência?</b></h3>
                        <p class="mt-2 text-dark">Prepare-se para o mercado com os melhores professores! Nossos cursos proporcionam uma base teórica sólida, complementada por um carta de estágio. Assim, você terá a oportunidade de buscar experiência prática na sua área de atuação, aumentando sua empregabilidade.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-2 col-11 p-1">
                <div class="card cta-box border h-100">
                    <div class="card-body p-2">
                        <div class="text-center">
                            <img class="img-fluid rounded-circle" src="{{asset('img/home_page/primeiroemprego.webp')}}" width="120" alt="Generic placeholder image">
                        </div>
                        <h3 class="mt-3 fw-normal cta-box-title text-center text-danger">Está buscando o seu <b>primeiro emprego?</b></h3>
                        <p class="mt-2 text-dark">Dê o primeiro passo na sua carreira com confiança! Nosso programa de capacitação é desenhado para garantir que você entre no mercado de trabalho pronto para impressionar desde o primeiro dia.
            ...
            <div class="col-lg-2 col-11 p-1">
                <div class="card cta-box border h-100">
                    <div class="card-body p-2">
                        <div class="text-center">
                            <img class="img-fluid rounded-circle" src="{{asset('img/home_page/empregomelhor.webp')}}" width="120" alt="Generic placeholder image">
                        </div>
                        <h3 class="mt-3 fw-normal cta-box-title text-center text-danger">Você quer um <b>salário melhor?
                        </b></h3>
                        <p class="mt-2 text-dark">Impulsione seu potencial de ganhos! Com nossa formação, você se qualifica para posições mais elevadas e salários competitivos. Seja um profissional requisitado e valorizado no mercado.</p>
                    </div>
                </div>
            </div>
        </div>
...
{!!$pagina['botao_whatsapp_flutuante']!!}
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $(document).ready(function() {
            $('.lead').on('click', function(event) {
                ...
                $.ajax({
                    url: '/meta_api/Lead', // Substitua pela sua rota POST
                    type: 'POST',
                    data: {
                        // Dados a serem enviados no POST
                        evento: 'Lead' // Exemplo de dado
                    },
                    headers: {
...
{{-- //FACEBOOK PIXEL PADRÃO NAVEGADOR --}}
@if($pagina['pidel_id'])
<!-- Facebook Pixel Code -->
<script>
...
<noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id={{(int)$pagina['pidel_id']}}&ev=PageView&noscript=1"/></noscript>
@endif
@yield('scripts')
</body>
