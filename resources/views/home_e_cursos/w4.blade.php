...
<html lang="pt-BR">
  ...
  <body>
    ...
    <section class=" container my-5">
        <div class=" row">
            <div class=" col-12 text-center">
                ...
                <a href="#btn-escolher-curso" class="btn btn-lg btn-primary text-white mt-4">Escolher meu curso agora!</a>
            </div>
        </div>
    </section>
    ...
    <script>
        //MOSTRAR BOTÃO DO WHATSAPP DEPOIS DE ALGUNS SEGUNDOSSaiba
