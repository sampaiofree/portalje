...
@media (min-width: 769px) {
  ...
  <body style="box-sizing: border-box;">
    ...
    <section class="hero" style="box-sizing: border-box; justify-content: center !important; align-items: center !important; display: flex !important;@if($info['cidade'] OR $desconto_banner) padding-top: 100px; @endif">
        ...
        @if($info['cidade'])
            <h1 class="mt-4 fw-bold" style="color: white; font-weight: 700 !important; text-shadow: 1px 1px 10px rgb(0, 0, 0);">Liberado para <span class="text-uppercase" style="color: #fdfd88;font-size:2rem;">{{$info['cidade']}}</span> o <u>Programa Nacional de Capacitação Profissional</u> </h1>
            <h2 id="headline" class="fw-bold mb-4 color4 mx-auto" style="color: #fdfd88; text-shadow: 1px 1px 10px rgb(0, 0, 0);">Uma iniciativa privada dedicada a preparar pessoas às melhores <strong>oportunidades de emprego em {{$info['cidade']}}</strong> e região.</h2>
        @else
            <h1 class="mt-4 fw-bold" style="color: white; font-weight: 700 !important; text-shadow: 1px 1px 10px rgb(0, 0, 0);">Participe no nosso <u>Programa Nacional de Capacitação Profissional</u> </h1>
            <h2 id="headline" class="fw-bold mb-4 color4 mx-auto" style="color: #fdfd88; text-shadow: 1px 1px 10px rgb(0, 0, 0);">Uma iniciativa privada dedicada a preparar pessoas <span class="bg-warning">às melhores oportunidades de emprego.</span></h2>
        @endif 
        
        <a href="#sessao_cursos" class="btn-cta text-uppercase" style="text-align: center !important;">Descubra sua nova profissão</a> 
        ...
        <div id="selos_primeira_dobra" class="mt-3 text-white" style="">
            <div class="row text-center d-flex align-items-center">
                ...
                <div class="col-4 col-md-2">
                    <img src="{{asset('img/icons/compra_segura2.webp')}}" style="width: 95.6667px; height: 40.95x" class="img-fluid " alt="Imagem 2">
                    
                   
                </div>
                <div class="col-4 col-md-2">
                    <img src="{{asset('img/icons/garantia2.webp')}}" style="width: 73.15px; height: 65px" class="img-fluid " alt="Imagem 3">                 
            ...
            <div class="row mt-1">
                ...
                <div class="col-4 col-md-2">
                    ...
                    <p style="font-size: xx-small; color: white;">Site confiável e autenticado por empresas de segurança na web</p>
                </div>
                <div class="col-4 col-md-2">
                    
                    
                    <p style="font-size: xx-small; : white;">Se não estiver satisfeito, devolvemos 100% do seu dinheiro, sem complicações.</p>
                </div>
            </div>
        </div>
    ...
    <section style="text-align: center !important; background-color: white; padding-top: 3rem !important;padding-bottom: 3rem !important;">
        ...
        <h3 class="text-center fw-bold my-0" style="font-weight: 700 !important;box-sizing: border-box;font-size: calc(1.3rem + .6vw);">
            Mais de <span style="font-weight: bolder;" class="color2">112 mil alunos</span> em todo o Brasil e em +14 países.
        </h3>
    ...
    <section id="sessao_cursos" class="lazy-load py-5 color1">
        <div class="container-fluid">
            <h3 id="beneficios_h3" class="fw-bold text-center">Nossos Cursos Disponíveis para Você se Qualificar</h3>
            <p class="lead text-center">Escolha o curso ideal para começar sua jornada profissional</p>

            <div id="lista_cursos" class="row mt-3" style="max-width: 1100px;">
                @php
                    $notas = [
                        "4.9",
                        "5",
                ...
                @foreach ($cursos as $curso)
                    @php
                        ...
                        if ($curso->numero_alunos<1001) {
                            $curso->numero_alunos += 3158;
                        }
                    ...
                    <div class="lazy-load col-12 col-sm-6 col-lg-4 mb-2 mt-1 py-1 pb-3" style="border-bottom: 10px solid #cccccc5e;">
                        <div class="row row_curso_individual align-items-center d-flex">
                                ...
                                <div class="img-overlay">
                                    ...
                                    <div class="img-gradient-overlay">
                                        <div class="img-title text-white">
                                            <p class="m-0 text-center" style="font-size: 1rem; font-weight: bold;line-height: 1.1;">{{$curso['titulo']}}</p>
                            ...
                            <div class="col-6">
                                ...
                                <a onclick="@if(!$info['whatsapp']) fbq('track', 'ViewContent') @elseif(!$info['formulario']) fbq('track', 'Lead') @endif" data-cursoid="{{$curso->id}}" href="{{$curso->link_checkout_completo}}" class="mt-1 btn-cta btn-inscricao text-center" style="font-size: small; padding-bottom: 10px; padding-top: 10px;">SAIBA MAIS</a> 
                            </div>
                        </div>
                    </div>
                    @endif
    ...
    <div class="modal fade" id="inscricaoModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen">
            ...
            <div class="modal-body">
                <p style="line-height: 1.3;font-weight: 400;">Precisamos de algumas informações rápidas para garantir seu acesso ao curso. Isso nos ajuda a manter você atualizado sobre o conteúdo e certificação.</p>
                ...
                <form id="inscricaoForm" action="{{ route('lead_whatsapp') }}" method="POST">
                    <div class="mb-3">                    
                        ...
                        <div class="form-text mt-0 ms-2" style="font-size: 0.7rem;">Seu nome será impresso no certificado.</div>
                    </div>
                    ...
                    <input id="input_lead_href" type="hidden" name="curso_id" value="">
                    <input id="input_lead_origem" type="hidden" name="origem" value="">
        ...
        * ##################################*/ 
        window.onload = function() {
            ...
            bootstrapJS.onload = function() {
                ...
                links.forEach(link => {
                    link.addEventListener('click', function (event) {
                        ...
                        // Obtenha o data do link clicado
                        const datacursoid = link.getAttribute('data-cursoid');

                        // Obtenha o href do link clicado
                        const href = link.getAttribute('href');

                        // Altere o link de redirecionamento no botão de confirmação
                        $('#input_lead_curso_id').val(datacursoid);
                        $('#input_lead_href').val(href);
            ...
            $('#inscricaoForm').on('submit', function(event) {
                ...
                var input_lead_link = $('#input_lead_href').val();
    ...
    <noscript><img height="1" width="1" style="display:none"
        ...
        /></noscript>
        @if(isset($curso->meta_pixel_id) AND $curso->meta_pixel_id)
        <noscript><img height="1" width="1" style="display:none"
