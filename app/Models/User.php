...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected $fillable = [
        ...
        'w3_whatsapp_float_show_home',
        'w3_whatsapp_float_show_courses',
        'site_contact_provider',
        'dominio',
        'dominio_externo',
        'home_page_layout',
    ...
    protected $casts = [
        ...
        'w3_whatsapp_float_show_home' => 'boolean',
        'w3_whatsapp_float_show_courses' => 'boolean',
        'site_contact_provider' => 'string',
